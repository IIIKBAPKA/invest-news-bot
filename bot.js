...
async function run() {
    try {
        ...
        for (const item of uniqueItems.slice(0, 10)) {
            ...
            Якщо вона НЕ стосується тікерів: ${Object.keys(TARGET_COMPANIES).join(', ')} або новина неважлива (важливість 3 і менше) чи просто інформаційний шум без конкретної новини — відповідай SKIP.
