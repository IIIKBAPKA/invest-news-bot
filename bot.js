...
async function run() {
    try {
        ...
        for (const item of uniqueItems.slice(0, 10)) {
            ...
            Якщо вона НЕ стосується тікерів: ${Object.keys(TARGET_COMPANIES).join(', ')} або новина якась дуже неважлива чи просто якийсь факт що щось виросло без конкретики — відповідай SKIP.
